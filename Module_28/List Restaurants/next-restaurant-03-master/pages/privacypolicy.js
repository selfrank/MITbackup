...
export default function PrivacyPolicy() {
    return(
<p>
<h2>Sample Website Privacy Policy Template</h2><br/>
...
<br/><br/>We reserve the right to change this policy at any given time, of which you will be promptly updated. If you want to make sure that you are up to date with the latest changes, we advise you to frequently visit this page.
<br/><h3>What User Data We Collect<br/>
When you visit the blog, we may collect the following data:</h3>
•	Your IP address.<br/>
